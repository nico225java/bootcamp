public class DemoWrapper {
    public static void main(String[] args) {
      ...
      System.out.println(Character.valueOf('c').compareTo(c1));//-1
      System.out.println(Character.valueOf('c').compareTo(Character.valueOf('c')));

      //Wrapper Class of boolean
      Boolean b3 = Boolean.value(true);
      ...
      long i5 = Long.valueOf(10L);
        //long -> Integer
        long i6 = Long.valueOf(10L);
        
        // Long ->long ->int -> (autobox) Integer
        Integer i7 = (int) ((long) Long.valueOf(10L));

        //!!compareTo()
        int age = 102;
        //!!Integer never use>, <,>=,<=, We should usee compareTo for comparison
        ...
        String s10 ="abcd";
        String s11 ="bcde";
        System.out.println(s11.compareTo(s10));//1(compare first chhar, b-a)
        System.out.println(s10.compareTo(s11));//1(compare first chhar, a-b)
        String s12 = "ccde";
